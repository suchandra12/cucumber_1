    ...
    stage('Run Tests') {
      ...
      post {
        always {
          ...
          emailext attachLog: true, to: 'reddysuchi197@gmail.com, suchandra@iqhqsolutions.com', subject: "Test Report - ${currentBuild.fullDisplayName}", mimeType: 'text/html', body: 'Please find the attached test reports.', replyTo: 'noreply@yourdomain.com'
        }
      }
    }
  }
